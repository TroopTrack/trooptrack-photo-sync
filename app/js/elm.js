...
Elm.Credentials.make = function (_elm) {
   ...
   var Cap = {ctor: "Cap"};
   var BsaTeam = {ctor: "BsaTeam"};
   var NzGrp = {ctor: "NzGrp"};
   var BadenPowell = {ctor: "BadenPowell"};
   var AuPack = {ctor: "AuPack"};
   var BsaCrew = {ctor: "BsaCrew"};
   var BsaClub = {ctor: "BsaClub"};
   var BsaCubs = {ctor: "BsaCubs"};
   var AhgTroop = {ctor: "AhgTroop"};
   var TlTroop = {ctor: "TlTroop"};
   var GsaTroop = {ctor: "GsaTroop"};
   var BsaTroop = {ctor: "BsaTroop"};
   var initializeTroopTypes = function () {
      var typesList = _U.list([{ctor: "_Tuple2",_0: 1,_1: BsaTroop}
                              ,{ctor: "_Tuple2",_0: 5,_1: GsaTroop}
                              ,{ctor: "_Tuple2",_0: 6,_1: AhgTroop}
                              ,{ctor: "_Tuple2",_0: 3,_1: BsaCubs}
                              ,{ctor: "_Tuple2",_0: 7,_1: BsaClub}
                              ,{ctor: "_Tuple2",_0: 9,_1: BsaCrew}
                              ,{ctor: "_Tuple2",_0: 10,_1: AuPack}
                              ,{ctor: "_Tuple2",_0: 12,_1: TlTroop}
                              ,{ctor: "_Tuple2",_0: 8,_1: BadenPowell}
                              ,{ctor: "_Tuple2",_0: 13,_1: NzGrp}
                              ,{ctor: "_Tuple2",_0: 14,_1: BsaTeam}
                              ,{ctor: "_Tuple2",_0: 15,_1: Cap}
                              ,{ctor: "_Tuple2",_0: 17,_1: SeaScouts}]);
      return $Dict.fromList(typesList);
   }();
   ...
   return _elm.Credentials.values = {_op: _op
                                    ...
                                    ,Cap: Cap
                                    ,SeaScouts: SeaScouts
                                    ,UnknownTroopType: UnknownTroopType
                                    ,initialCredentials: initialCredentials
                                    ,initializeTroopTypes: initializeTroopTypes};
};
Elm.Login = Elm.Login || {};
...
Elm.Pages.make = function (_elm) {
   ...
   if (_elm.Pages.values) return _elm.Pages.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Login.Update.make = function (_elm) {
   ...
   A2($Json$Decode._op[":="],"troop_id",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"troop_number",$Json$Decode.string),
   A2($Json$Decode._op[":="],"troop_type",$Json$Decode.string),
   A2($Json$Decode._op[":="],"troop_type_id",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"user_id",$Json$Decode.$int));
   var userListDecoder = $Json$Decode.list(userDecoder);
   var authDecoder = A2($Json$Decode.at,_U.list(["users"]),userListDecoder);
   var sendAuthRequest = function (model) {
      return A2($Http.fromJson,
      authDecoder,
      A2($Http.send,
      $Http.defaultSettings,
      {verb: "POST"
      ,headers: _U.list([{ctor: "_Tuple2",_0: "X-Partner-Token",_1: model.credentials.partnerToken}
...
Elm.PhotoAlbums.Update.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var networkErrorMessage = function (err) {
      var _p0 = err;
      switch (_p0.ctor)
      {case "Timeout": return "Having trouble reaching the server";
         case "NetworkError": return "You don\'t appear to be connected to the network";
         case "UnexpectedPayload": return A2($Basics._op["++"],"Received an unexpected result from the server: ",_p0._0);
   ...
   A2($Json$Decode._op[":="],"photo_album_id",$Json$Decode.$int),
   $Json$Decode.oneOf(_U.list([A2($Json$Decode._op[":="],"troop_photos",$Json$Decode.list(photoDecoder)),$Json$Decode.succeed(_U.list([]))])));
   var photoAlbumsDecoder = A2($Json$Decode.at,_U.list(["photo_albums"]),$Json$Decode.list(photoAlbumDecoder));
   var sendPhotoAlbumDetailsRequest = F3(function (partnerToken,user,album) {
      return A2($Http.fromJson,
      photoAlbumDecoder,
      A2($Http.send,
      $Http.defaultSettings,
      {verb: "GET"
      ,headers: _U.list([{ctor: "_Tuple2",_0: "X-Partner-Token",_1: partnerToken},{ctor: "_Tuple2",_0: "X-User-Token",_1: user.token}])
      ,url: A2($Basics._op["++"],"https://trooptrack.com/api/v1/photo_albums/",$Basics.toString(album.photoAlbumId))
      ,body: $Http.empty}));
   });
   var sendPhotoAlbumsRequest = F2(function (partnerToken,user) {
      return A2($Http.fromJson,
      photoAlbumsDecoder,
      A2($Http.send,
      $Http.defaultSettings,
   ...
   var fetchAlbumDetails = F3(function (partnerToken,user,album) {
      var _p1 = user;
      if (_p1.ctor === "Nothing") {
            return $Effects.task(A2($Task.map,$Basics.always(NoOp),$Task.succeed({ctor: "_Tuple0"})));
         } else {
   ...
   var update = F3(function (action,partnerToken,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         ...
         case "DisplayPhotoAlbums": var _p4 = _p2._0;
           if (_p4.ctor === "Ok") {
                 var _p5 = _p4._0;
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{photoAlbums: _p5})
                        ,_1: $Effects.batch(A2($List.map,A2(fetchAlbumDetails,partnerToken,model.user),_p5))};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: errorNotification(networkErrorMessage(_p4._0))};
              }
         case "UpdatePhotoAlbum": var _p6 = _p2._0;
           if (_p6.ctor === "Ok") {
                 var updateAlbum = F2(function ($new,old) {    return _U.eq($new.photoAlbumId,old.photoAlbumId) ? $new : old;});
                 return {ctor: "_Tuple2",_0: _U.update(model,{photoAlbums: A2($List.map,updateAlbum(_p6._0),model.photoAlbums)}),_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: errorNotification(networkErrorMessage(_p6._0))};
              }
...
Elm.Layouts.make = function (_elm) {
   ...
   if (_elm.Layouts.values) return _elm.Layouts.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var centered = function (content) {
      ...
      _U.list([A2($Html.img,_U.list([$Html$Attributes.src("img/logo-large.png"),$Html$Attributes.alt("TroopTrack")]),_U.list([]))
...
Elm.Login.View.make = function (_elm) {
   ...
   var submitButton = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.$class("button expanded")
              ,$Html$Attributes.disabled(model.authenticating)
   ...
   var successMessage = function (model) {
      ...
      if (_p1.ctor === "Nothing") {
            ...
            return A2($Html.div,_U.list([$Html$Attributes.$class("text-center success callout")]),_U.list([$Html.text(_p1._0)]));
         }
   };
...
Elm.PhotoAlbums.View.Helpers = Elm.PhotoAlbums.View.Helpers || {};
Elm.PhotoAlbums.View.Helpers.make = function (_elm) {
   "use strict";
   _elm.PhotoAlbums = _elm.PhotoAlbums || {};
   _elm.PhotoAlbums.View = _elm.PhotoAlbums.View || {};
   _elm.PhotoAlbums.View.Helpers = _elm.PhotoAlbums.View.Helpers || {};
   if (_elm.PhotoAlbums.View.Helpers.values) return _elm.PhotoAlbums.View.Helpers.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.PhotoAlbums.View.Helpers.values = {_op: _op,fontAwesome: fontAwesome,nowrapText: nowrapText};
};
Elm.PhotoAlbums = Elm.PhotoAlbums || {};
Elm.PhotoAlbums.View = Elm.PhotoAlbums.View || {};
...
Elm.PhotoAlbums.View.Menu.make = function (_elm) {
   ...
   _elm.PhotoAlbums = _elm.PhotoAlbums || {};
   _elm.PhotoAlbums.View = _elm.PhotoAlbums.View || {};
   _elm.PhotoAlbums.View.Menu = _elm.PhotoAlbums.View.Menu || {};
   if (_elm.PhotoAlbums.View.Menu.values) return _elm.PhotoAlbums.View.Menu.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var menuStateClass = function (model) {    var _p0 = model.menuState;if (_p0.ctor === "MenuOn") {    return "active";} else {    return "";}};
   ...
   var troopMenu = F2(function (address,model) {
      ...
      if (_p2.ctor === "Nothing") {
            ...
            var isCurrent = function (album) {    var _p3 = album;if (_p3.ctor === "Nothing") {    return true;} else {    return false;}};
            return A2($Html.ul,
            _U.list([$Html$Attributes.$class("menu-items")]),
            _U.list([A5(menuItem,
            address,
            $PhotoAlbums$Update.CurrentAlbum($Maybe.Nothing),
            $PhotoAlbums$View$Helpers.fontAwesome("angle-down"),
            _p2._0.troop,
   ...
   var menu = F2(function (address,model) {
      ...
      _U.list([A2($Html.ul,
              ...
              _U.list([A5(menuItem,
                      address,
                      $PhotoAlbums$Update.SetMenuState($PhotoAlbums$Model.MenuOff),
                      $PhotoAlbums$View$Helpers.fontAwesome("times"),
                      "Close Menu",
                      false)
                      ,A5(menuItem,address,$PhotoAlbums$Update.Logout,$PhotoAlbums$View$Helpers.fontAwesome("sign-out"),"Sign out",false)
                      ,A5(menuItem,address,$PhotoAlbums$Update.DisplayTroopSelection,$PhotoAlbums$View$Helpers.fontAwesome("users"),"Troops",false)]))
              ,A2(troopMenu,address,model)
              ,A2(albumsMenu,address,model)]));
   });
   return _elm.PhotoAlbums.View.Menu.values = {_op: _op
                                              ,menu: menu
                                              ,troopMenu: troopMenu
...
Elm.PhotoAlbums = Elm.PhotoAlbums || {};
Elm.PhotoAlbums.View = Elm.PhotoAlbums.View || {};
Elm.PhotoAlbums.View.Topbar = Elm.PhotoAlbums.View.Topbar || {};
Elm.PhotoAlbums.View.Topbar.make = function (_elm) {
   "use strict";
   _elm.PhotoAlbums = _elm.PhotoAlbums || {};
   _elm.PhotoAlbums.View = _elm.PhotoAlbums.View || {};
   _elm.PhotoAlbums.View.Topbar = _elm.PhotoAlbums.View.Topbar || {};
   if (_elm.PhotoAlbums.View.Topbar.values) return _elm.PhotoAlbums.View.Topbar.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.PhotoAlbums.View.Topbar.values = {_op: _op,topbar: topbar};
};
Elm.PhotoAlbums = Elm.PhotoAlbums || {};
Elm.PhotoAlbums.View = Elm.PhotoAlbums.View || {};
Elm.PhotoAlbums.View.Gallery = Elm.PhotoAlbums.View.Gallery || {};
Elm.PhotoAlbums.View.Gallery.make = function (_elm) {
   "use strict";
   _elm.PhotoAlbums = _elm.PhotoAlbums || {};
   _elm.PhotoAlbums.View = _elm.PhotoAlbums.View || {};
   _elm.PhotoAlbums.View.Gallery = _elm.PhotoAlbums.View.Gallery || {};
   if (_elm.PhotoAlbums.View.Gallery.values) return _elm.PhotoAlbums.View.Gallery.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Credentials = Elm.Credentials.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var photoThumbnail = F3(function (address,model,photo) {
      var downloadButtonStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-size",_1: "1.2em"},{ctor: "_Tuple2",_0: "padding",_1: "10px"}]));
      ...
      var downloadButton = function () {
         ...
         if (_p0.ctor === "Nothing") {
               return A2($Html.a,
               _U.list([$Html$Attributes.href("#")
                       ,$Html$Attributes.title("Download Photo")
                       ,A2($Html$Events.onClick,address,$PhotoAlbums$Update.DownloadPhoto(photo))]),
               _U.list([$PhotoAlbums$View$Helpers.fontAwesome("download")]));
            } else {
   ...
   var troopImage = F2(function (troopTypes,user) {
      ...
      {case "BsaTroop": return A2($Html.img,_U.list([$Html$Attributes.src("img/bsa_share.png")]),_U.list([]));
         ...
         case "BsaCubs": return A2($Html.img,_U.list([$Html$Attributes.src("img/pack_share.png")]),_U.list([]));
         case "BsaClub": return A2($Html.img,_U.list([$Html$Attributes.src("img/bsa_share.png")]),_U.list([]));
         case "BsaCrew": return A2($Html.img,_U.list([$Html$Attributes.src("img/bsa_share.png")]),_U.list([]));
         case "AuPack": return A2($Html.img,_U.list([$Html$Attributes.src("img/bsa_share.png")]),_U.list([]));
         case "TlTroop": return A2($Html.img,_U.list([$Html$Attributes.src("img/tl_share.png")]),_U.list([]));
         case "BadenPowell": return A2($Html.img,_U.list([$Html$Attributes.src("img/bsa_share.png")]),_U.list([]));
         case "NzGrp": return A2($Html.img,_U.list([$Html$Attributes.src("img/bsa_share.png")]),_U.list([]));
         case "BsaTeam": return A2($Html.img,_U.list([$Html$Attributes.src("img/bsa_share.png")]),_U.list([]));
         case "Cap": return A2($Html.img,_U.list([$Html$Attributes.src("img/cap_share.png")]),_U.list([]));
         case "SeaScouts": return A2($Html.img,_U.list([$Html$Attributes.src("img/ship_share.png")]),_U.list([]));
         default: return A2($Html.img,_U.list([$Html$Attributes.src("img/bsa_share.png")]),_U.list([]));}
   });
   var troopThumb = F3(function (address,troopTypes,user) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("gallery-item")]),
      _U.list([A2($Html.a,
              ...
              ,A2($Html.a,
              _U.list([$Html$Attributes.href("#"),A2($Html$Events.onClick,address,$PhotoAlbums$Update.LoadPhotoAlbums(user))]),
              _U.list([A2(troopImage,troopTypes,user)]))]));
   });
   var troopSelection = F4(function (address,troopTypes,credentials,model) {
   ...
   return _elm.PhotoAlbums.View.Gallery.values = {_op: _op
                                                 ,content: content
...
Elm.PhotoAlbums.View.make = function (_elm) {
   ...
   $PhotoAlbums$Model = Elm.PhotoAlbums.Model.make(_elm),
   $PhotoAlbums$Update = Elm.PhotoAlbums.Update.make(_elm),
   $PhotoAlbums$View$Gallery = Elm.PhotoAlbums.View.Gallery.make(_elm),
   $PhotoAlbums$View$Menu = Elm.PhotoAlbums.View.Menu.make(_elm),
   $PhotoAlbums$View$Topbar = Elm.PhotoAlbums.View.Topbar.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = F4(function (address,troopTypes,credentials,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($PhotoAlbums$View$Topbar.topbar,address,model)
              ,A2($Html.div,_U.list([$Html$Attributes.$class("content")]),_U.list([A4($PhotoAlbums$View$Gallery.content,address,troopTypes,credentials,model)]))
              ,A2($PhotoAlbums$View$Menu.menu,address,model)
              ,$PhotoAlbums$View$Menu.mask(model)]));
   });
   return _elm.PhotoAlbums.View.values = {_op: _op,view: view};
};
...
Elm.App.View.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      ...
      {case "LoadingPage": return $Loading$View.view;
         ...
         default: return A4($PhotoAlbums$View.view,
           A2($Signal.forwardTo,address,$App$Update.PhotoAlbums),
           model.troopTypes,
